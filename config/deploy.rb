...
role :web, "rhodes-pc-2.com"                          # Your HTTP server, Apache/etc
role :app, "rhodes-pc-2.com"                         # This may be the same as your `Web` server
role :db,  "rhodes-pc-2.com"   , :primary => true # This is where Rails migrations will run
